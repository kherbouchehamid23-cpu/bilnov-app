#!/usr/bin/env bash
set -euo pipefail
SCRIPTS="01_apply_cad_measure_tests 02_apply_cad_cursor_edit 03_apply_share_measure 04_apply_m1_comments 05_apply_m1_front 07_apply_m1_final 08_apply_m3_locations 09_apply_measure_engines 10_apply_measure_viewer 11_apply_quick_measure"
echo "==> Preflight"
for s in $SCRIPTS; do
...
git add -A
git commit -m "feat(bilnov): M1 complet + M3 localisations + outil mesure AutoCAD (snap riche, ortho, previsualisation, mesure rapide)"
git push

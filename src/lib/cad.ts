...
// conversion LibreDWG hors thread + extraction des repères d'accrochage, des
// SEGMENTS (murs/lignes) et de l'unité native du dessin.
 ...
 * affichable par dxf-viewer, plus les repères d'accrochage, les segments et l'unité native.
